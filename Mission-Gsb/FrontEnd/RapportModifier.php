...
<?php
	...
	?>
  <table style="width: 100%" class="tableauTitre">
    <tr>
      <td style="width: 50%; text-align: right;" id="titre"><h1>Rapport de visite - modification&nbsp;&nbsp;</h1></td>
    </tr>
  </table>
  ...
  <input type="hidden" name="rapNum" value="<?php echo $rapNum ?>">
  	...
  	<fieldset class="separateur" id="infPerso"><legend class="legende">Infos personnelles</legend>
         <table>
            <tr>
              ...
              <td id="matricule"><?php echo $_SESSION['num']; ?> </td>
            </tr>
            ...
            <tr>
              ...
              <td id="date"><?php echo $date = date("Y-m-d"); ?></td>
            </tr>
          </table>
  	</fieldset>
    ...
    ?>
        ...
        <label for="rapBilan">Bilan du Rapport</label>
            <textarea id="rapBilan" name="rapBilan" rows="5" cols="33" placeholder="Saissez le nouveau bilan"><?php echo $rapBilan; ?>
            </textarea>
        </p>
    ...
    <select name="rapMotif" id="rapMotif">
  	...
  	<p>
        ...
        <input onclick="location.href='Rapports.php';" class="bouton" type="reset" id="annule" name="boutonAnnuler" value="Annuler" />
