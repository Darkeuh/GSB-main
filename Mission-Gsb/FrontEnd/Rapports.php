...
<head>
	<title>Modification de rapport - GSB</title >
...
?>
    <h1 style="position: absolute; left: 40%; width: 50%;">Vos rapports</h1>
 ...
 <?php 
     ...
     $reqSQL1 = "SELECT Motiflibelle From motifrapport m, rapportvisite r where m.Motifid = r.idMotif AND m.Motifid ='$rapid'";
     $result1 = $connexion->query($reqSQL1);
     $ligne1 = $result1->fetch();


 echo "<table class='rapport'>";
